  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            university's comprehensive education progrmas. Our cutting-edge 
            curriculumis designed to empower students with the knowledge, 
            skills, and experience needed to excel in the dynamic field of 
            education.</p>
            <p>With a focus on innovatiion, heads-on learning, and personalized 
            mentorship, our program prepare aspiring educators to make a 
            meaningful impact in classrooms, schools and communties.</p>
            <p>Whether you aspire to become a teacher, administrator, 
            counselor, or educational leader our diverse range of programs 
            offers the perfect pathway tp achieve your goals and unlock your 
